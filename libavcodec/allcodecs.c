...
void avcodec_register_all(void)
{
    ...
    REGISTER_DECODER (CHDH264, chdh264);
    REGISTER_DECODER (CHDMPEG1, chdmpeg1);
    REGISTER_DECODER (CHDMPEG2, chdmpeg2);
    REGISTER_DECODER (CHDDIVX, chddivx);
    REGISTER_DECODER (CHDDIVX3, chddivx3);
    REGISTER_DECODER (CHDVC1, chdvc1);
    REGISTER_DECODER (CHDWMV3, chdwmv3);
